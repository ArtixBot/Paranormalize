...
public abstract class AbstractAbility : IEventSubscriber, IEventHandler<CombatEventAbilityActivated>, IEventHandler<CombatEventRoundEnd>
{
    ...
    public string ID;
    public string NAME;
    public Dictionary<string, string> STRINGS = [];      // STRINGS contains all localized information for the ability and its associated dice.
                           ...
                           bool FIXED_COOLDOWN = false)
    {
        ...
        this.STRINGS = ABILITY_STRINGS.STRINGS ?? [];
        this.TYPE = TYPE;
        ...
        this.targetingModifiers = targetingModifiers ?? [];
